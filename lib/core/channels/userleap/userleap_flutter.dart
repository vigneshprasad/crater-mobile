...
mixin UserLeapFlutter {
  static const MethodChannel _channel = MethodChannel('userleap_flutter');
  ...
  static Future presentDebugSurvey() async {
    return _channel.invokeMethod(Channels.PRESENT_DEBUG_SURVEY);
  }
  ...
  static Future logout() async {
    return _channel.invokeMethod(Channels.LOGOUT);
  }
