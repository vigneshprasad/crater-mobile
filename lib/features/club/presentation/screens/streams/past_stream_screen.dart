...
class PastStreamScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final pastStreamProvider = useProvider(pastStreamsStateProvider(categoryId));
      ...
      body: SafeArea(
        child: NestedScrollView(
          ...
          body: RefreshIndicator(
            ...
            onRefresh: () {
              final futures = [
                context.read(pastStreamsStateProvider(categoryId).notifier).getPastData(),
              ];
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      switch (streams[upIndex].type) {
                        ...
                        default:
                          return Column(
                            children: [
                              if (index == 0 && categoryId == null) CategoryGridView(),
                              AspectRatio(
                                aspectRatio: 4.0 / 3.0,
                                child: Container(
                                    width: double.infinity,
...
class CategoryGridView extends HookWidget {
  @override
  Widget build(BuildContext context) {
    final webinarCategoryProvider = useProvider(webinarCategoryStateProvider);
    return Container(
          ...
          data: (categoryList) {
            return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      AutoRouter.of(context).navigate(PastStreamScreenRoute(
