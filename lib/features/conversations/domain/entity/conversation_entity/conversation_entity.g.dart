...
_$_Conversation _$$_ConversationFromJson(Map<String, dynamic> json) =>
    _$_Conversation(
      ...
      privacy:
          $enumDecodeNullable(_$ConversationPrivacyEnumMap, json['privacy']),
      medium: $enumDecodeNullable(_$ConversationMediumEnumMap, json['medium']),
...
_$_RecordingDetails _$$_RecordingDetailsFromJson(Map<String, dynamic> json) =>
    _$_RecordingDetails(
      recording: json['recording'] as String?,
    );

Map<String, dynamic> _$$_RecordingDetailsToJson(_$_RecordingDetails instance) =>
    <String, dynamic>{
      'recording': instance.recording,
    };

_$_ConversationUser _$$_ConversationUserFromJson(Map<String, dynamic> json) =>
    _$_ConversationUser(
...
Map<String, dynamic> _$$_ConversationUserToJson(_$_ConversationUser instance) =>
    <String, dynamic>{
      'pk': instance.pk,
...
_$_ConversationByDate _$$_ConversationByDateFromJson(
        Map<String, dynamic> json) =>
    _$_ConversationByDate(
      date:
...
Map<String, dynamic> _$$_ConversationByDateToJson(
...
_$_UserPermission _$$_UserPermissionFromJson(Map<String, dynamic> json) =>
    _$_UserPermission(
      allowCreateStream: json['allow_create_stream'] as bool?,
      allowChat: json['allow_chat'] as bool?,
    );

Map<String, dynamic> _$$_UserPermissionToJson(_$_UserPermission instance) =>
    <String, dynamic>{
