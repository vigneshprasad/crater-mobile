...
class GroupsDetailList with _$GroupsDetailList {
  ...
  factory GroupsDetailList.fromJson(Map<String, dynamic> json) =>
      _$GroupsDetailListFromJson(json);
}
...
class CategoriesDetailList with _$CategoriesDetailList {
  ...
  factory CategoriesDetailList.fromJson(Map<String, dynamic> json) =>
      _$CategoriesDetailListFromJson(json);
}
