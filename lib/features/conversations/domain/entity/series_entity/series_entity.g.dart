...
_$_GroupsDetailList _$_$_GroupsDetailListFromJson(Map<String, dynamic> json) {
  return _$_GroupsDetailList(
    id: json['id'] as int?,
    host: json['host'] as String?,
    topic: json['topic'] as int?,
...
Map<String, dynamic> _$_$_GroupsDetailListToJson(
        _$_GroupsDetailList instance) =>
    <String, dynamic>{
      'id': instance.id,
      'host': instance.host,
      'topic': instance.topic,
...
_$_CategoriesDetailList _$_$_CategoriesDetailListFromJson(
    Map<String, dynamic> json) {
  return _$_CategoriesDetailList(
    pk: json['pk'] as int?,
...
Map<String, dynamic> _$_$_CategoriesDetailListToJson(
...
_$_HostDetail _$_$_HostDetailFromJson(Map<String, dynamic> json) {
  return _$_HostDetail(
...
Map<String, dynamic> _$_$_HostDetailToJson(_$_HostDetail instance) =>
    <String, dynamic>{
      'pk': instance.pk,
