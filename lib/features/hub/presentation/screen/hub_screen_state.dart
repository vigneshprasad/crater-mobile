...
class HubScreenNotifier
    extends StateNotifier<AsyncValue<_HubScreenState>> {
  final Reader read;
  ...
  Future<void> retrieveProfile() async {
    ...
    final permission = response.getOrElse(() => UserPermission(allowChat: false, allowCreateStream: false));

    final _profileScreenState =
        _HubScreenState(permission: permission);
