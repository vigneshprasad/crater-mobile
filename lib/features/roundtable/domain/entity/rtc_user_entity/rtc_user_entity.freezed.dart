...
abstract class $RtcUserCopyWith<$Res> {
  ...
  $Res call(
      {RoundTableUser userInfo,
      String pk,
      bool online,
      bool muted,
      int volume});

  $RoundTableUserCopyWith<$Res> get userInfo;
}
...
class _$RtcUserCopyWithImpl<$Res> implements $RtcUserCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      userInfo:
          userInfo == freezed ? _value.userInfo : userInfo as RoundTableUser,
  ...
  $RoundTableUserCopyWith<$Res> get userInfo {
    ...
    return $RoundTableUserCopyWith<$Res>(_value.userInfo, (value) {
